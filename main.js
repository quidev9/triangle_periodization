...
// ============================================================
// 1. СМИТ ДОЛЖЕН БЫТЬ НЕ МЕНЬШЕ ГОРИЗОНТА
// ============================================================

if (b_curr < a_curr) {

    let b_diff = a_curr - b_curr;

    b_diff = Math.round(b_diff * 2) / 2;
    b_target = b_curr + b_diff;

    console.log("Смит слабее горизонта:", balanceRatio);
...
// ============================================================
// 2. ЕСЛИ СМИТ >= ГОРИЗОНТА — МОЖНО ПРОГРЕССИРОВАТЬ
// ============================================================
