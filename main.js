...
function calculate() {
    ...
    // ПРИОРИТЕТ:
    //
    // 1. Смит ниже горизонта?
    //    → добить Смит до горизонта.
    //
    // 2. Смит >= горизонта?
    ...
    if (b_curr < a_curr) {
        ...
        // Если Смит сильно слабее наклона
        if (
            balanceRatio <
            (1 - BALANCE_TOLERANCE)
        ) {
    ...
    //
    // Наклон здесь НЕ БЛОКИРУЕТ прогресс.
    //
    // Например:
    //
    // Горизонт = 120
    ...
    // ============================================================
        ...
        // Если наклон сильно отстаёт,
        // просто добавляем предупреждение,
        // но НЕ запрещаем пробовать горизонт.
        ...
        if (pC < 0.70) {
            ...
            adviceText +=
                `\n\nℹ️ Наклон немного отстаёт от ориентира 85%.\n` +
                `Можно подтянуть его параллельно.`;
        }
    }
